...
PRODUCTS: List[Product] = [
    ...
    Product(
        ...
        category="lasers",
        tag="Nd:YAG Q-Switch",
        short="Zaawansowany laser Nd:YAG Q-Switch do usuwania tatuaży, makijażu permanentnego i zmian pigmentacyjnych. Pracuje w nanosekundach, precyzyjnie rozbijając pigment i wspierając szeroki zakres procedur w gabinecie.",
        bullets=[
            "Technologia Nd:YAG Q-Switch - ultra krótkie impulsy o wysokiej energii.",
            "Zakres pracy: 532 nm, 755 nm, 1064 nm oraz 1320 nm.",
            "Zastosowania: tatuaże, makijaż permanentny, przebarwienia oraz carbon peeling.",
            "Parametry: do 2500 W, 100-2000 mJ, 1-10 Hz, ekran dotykowy 15,6 cala.",
        ],
        price="35 000 zł",
        badge="Nowość",
        pages=[],
    ...
    Product(
        ...
        name="Aqua Star",
        category="hi-tech",
        tag="platforma oczyszczania i regeneracji skóry (10 w 1)",
        short="Nowoczesne gabinety nie szukają już pojedynczych technologii. Szukają efektu. Aqua Star to urządzenie, które łączy najczęściej wykonywane zabiegi w jednym systemie - od głębokiego oczyszczania po zaawansowaną pielęgnację anti-aging.",
        bullets=[
            "Hydrafacial - głębokie oczyszczanie + infuzja składników aktywnych.",
            "Geneo / oxygen infusion - dotlenienie i rewitalizacja skóry.",
            "Analizer skóry HD - precyzyjna diagnostyka i dobór terapii.",
            "RF - poprawa napięcia i stymulacja kolagenu.",
            "Ultradźwięki - zwiększenie penetracji składników.",
            "Mikro lift (EMS) - lifting i poprawa owalu.",
            "Zimno/ciepło - zamykanie porów i wyciszenie skóry.",
            "Łopatka ultradźwiękowa - dokładne oczyszczanie.",
            "Wysokie podciśnienie (do 96 kPa), 3-strefowa głowica, RF + ultradźwięki + EMS w jednym systemie, ekran 10,4''.",
        ],
        price="35 000 zł",
        badge="Nowość",
        pages=list(range(99, 104)),
    ),
